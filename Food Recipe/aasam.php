...
<!-- End Header -->
<link rel="stylesheet" href="aasam.css">
...
<img alt="img" class="ls-s-1"  src="content/a2.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of Aasam</h1>
...
<img alt="img" class="ls-s-1"  src="content/pa.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of Aasam</h1>
...
<img alt="img" class="ls-s-1"  src="content/trada.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Aasam</h1>
...
<section id="home"></section>
        ...
        <div class="dish-container">
            <h4>Bihu Festival: Pitha (Assamese Rice Cake):</h4>
            <img src="populardishes/pitha.jpg" alt="" id="pitha">
            <div>
            <a href="pitha.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Magh Bihu:Pani Pitha:</h4>
            <img src="populardishes/panipitha.jpg" alt="" id="pani">
            <div>
            <a href="panipitha.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Baishagu:Bodo Style Rice and Black Sesame Dumplings:</h4>
            <img src="populardishes/bodo.jpg" alt="" id="bai">
            <div>
            <a href="baishagu.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Raas Festival:Makhana Kheer (Foxnut Pudding)</h4>
            <img src="populardishes/makhana.jpg" alt="" id="fox">
            <div>
            <a href="makhana.php"><button class="btn1">View Recipe</button></a>
            </div> 
</div>
