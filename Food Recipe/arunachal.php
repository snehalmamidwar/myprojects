...
<!-- End Header -->
<link rel="stylesheet" href="arunachal.css">
...
<img alt="img" class="ls-s-1"  src="content/apd.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of Arunachal pradesh</h1>
...
<img alt="img" class="ls-s-1"  src="content/pap.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of Arunachal pradesh</h1>
...
<img alt="img" class="ls-s-1"  src="content/tap.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Arunachal pradesh</h1>
...
<section id="home"></section>
        ...
        <div class="dish-container">
            <h4>Losar:Veg Thukpa</h4>
            <img src="populardishes/thukapa.jpg" alt="" id="thukapa">
            <div>
            <a href="thukapa.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Torgya:Momos - Dumplings</h4>
            <img src="populardishes/momo.jpg" alt="" id="momo">
            <div>
            <a href="momo.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Dree:Apong</h4>
            <img src="populardishes/apong.jpg" alt="" id="apong">
            <div>
            <a href="apong.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Mopin:Thentuk</h4>
            <img src="populardishes/then.jpg" alt="" id="then">
            <div>
            <a href="then.php"><button class="btn1">View Recipe</button></a>
            </div> 
</div>

            
          <div class="dish-container">
            <h4>Losar:PantaBhat</h4>
            <img src="populardishes/pantabhat.jpg" alt="" id="pantabhat">
            <div>
            <a href="pantabhat.php"><button class="btn1">View Recipe</button></a>
            </div> 
