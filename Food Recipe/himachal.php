...
<img alt="img" class="ls-s-1"  src="content/hb.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of Himachal</h1>
...
<img alt="img" class="ls-s-1"  src="content/madra.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of Himachal</h1>
...
<img alt="img" class="ls-s-1"  src="content/ht1.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Himachal</h1>
...
<section id="home"></section>
        ...
        <div class="dish-container">
            <h4>Dussehra:Sidu</h4>
            <img src="populardishes/sidu.jpg" alt="" id="sidu">
            <div>
            <a href="sidu.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Holi:Babru</h4>
            <img src="populardishes/babru.jpg" alt="" id="babru">
            <div>
            <a href="babru.php"><button class="btn1">View Recipe</button></a>
            </div> 
</div>
          ...
          <div class="dish-container">
            <h4>Lohri:Gachak</h4>
            <img src="populardishes/gajak.jpg" alt="" id="gachak">
            <div>
            <a href="gachak.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Shivratri:Khatta</h4>
            <img src="populardishes/khatta.jpg" alt="" id="khatta">
            <div>
            <a href="khatta.php"><button class="btn1">View Recipe</button></a>
            </div> 

</div>
            <div class="dish-container">
            <h4>Baisakhi:Patande</h4>
            <img src="populardishes/patande.jpg" alt="" id="patande">
            <div>
            <a href="patande.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>
            
          <div class="dish-container">
            <h4>Phulaich:Mitha</h4>
            <img src="populardishes/mitha.jpg" alt="" id="mitha">
            <div>
            <a href="mitha.php"><button class="btn1">View Recipe</button></a>
            </div> 
