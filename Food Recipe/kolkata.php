...
<!-- End Header -->
<link rel="stylesheet" href="kolkata.css">
<body  class="home blog header_2 fullwidth_slider">
<a href="kvideo.php"><button class="custom-button">videos</button></a>
...
<img alt="img" class="ls-s-1"  src="content/nan.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of Kolkata</h1>
...
<img alt="img" class="ls-s-1"  src="content/kofta.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of Kolkata</h1>
...
<img alt="img" class="ls-s-1"  src="content/tra.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Kolkata</h1>
...
<section id="home"></section>
        ...
        <div class="dish-container">
            <h4>Eid-ul-Fitr:sheer khurma</h4>
            <img src="populardishes/sheer.jpg" alt="" id="sheer">
            <div>
            <a href="sheer.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Eid-ul-Adha:Dum Aalo</h4>
            <img src="populardishes/dum.jpg" alt="" id="dum">
            <div>
            <a href="dum.php"><button class="btn1">View Recipe</button></a>
            </div> 
</div>


          <div class="dish-container">
            <h4>Navroz (Kashmiri New Year):Kashmiri Pulao</h4>
            <img src="populardishes/pulao.jpg" alt="" id="pulao">
            <div>
            <a href="pulao.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Shivratri:yakhani</h4>
            <img src="populardishes/yakhani.jpg" alt="" id="yakhani">
            <div>
            <a href="yakhani.php"><button class="btn1">View Recipe</button></a>
            </div> 

</div>
            <div class="dish-container">
            <h4>Shravan (Hari Parbat Yatra):Sabut Moong Dal</h4>
            <img src="populardishes/dal.jpg" alt="" id="dal">
            <div>
            <a href="dal.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>
            
          <div class="dish-container">
            <h4>Tulip Festival:Thali</h4>
            <img src="populardishes/tra.jpg" alt="" id="trad">
            <div>
            <a href="trad.php"><button class="btn1">View Recipe</button></a>
            </div> 
...
<!-- Mirrored from newthemes.themeple.co/maximushtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Sep 2014 11:56:24 GMT -->
</html>