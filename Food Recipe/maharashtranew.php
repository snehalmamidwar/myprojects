...
<!-- Mirrored from newthemes.themeple.co/maximushtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Sep 2014 11:47:27 GMT -->
<head>
...
<link rel="stylesheet" href="maharashtranew.css">
<!-- End Header -->
<body  class="home blog header_2 fullwidth_slider">
<a href="mvideo.php"><button class="custom-button">videos</button></a>
...
<!-- Layer Slider -->
	...
	<div id="layerslider_6" class="ls-wp-container" style="width: 100%; height: 460px; margin: 0px auto; ">
		<div class="ls-layer"  style="slidedirection: right; slidedelay: 4000; durationin: 1500; durationout: 1500; easingin: easeInOutQuint; easingout: easeInOutQuint; delayin: 0; delayout: 0; ">
			<img alt="img" class="ls-s-1"  src="content/images/all/09/31.jpg"  style="position: absolute; top: -61px; left: -492px; slidedirection : fade; slideoutdirection : fade;  durationin : 1800; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 200; delayout : 0; showuntil : 0; ">

<img alt="img" class="ls-s-1"  src="content/maha.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of Maharashtra</h1>
...
<img alt="img" class="ls-s-1"  src="content/vidarbha.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of Maharashtra</h1>
...
<img alt="img" class="ls-s-1"  src="content/trad1.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Maharashtra</h1>
...
<section id="home"></section>
         ...
         <h1>Food By Festivals:</h1>
         
         <div class="populardish">
        <div class="dish-container">
            <h4>NarliPurnima: NaraliBhat</h4>
            <img src="populardishes/naralibhat.jpg" alt="" id="naralibhat">
            <div>
            <a href="naralibhat.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Ganesh Chaturthi: Ukadicha Modak</h4>
            <img src="populardishes/modak.jpg" alt="" id="modak">
            <div>
            <a href="modak.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Diwali:Faral</h4>
            <img src="populardishes/faral.jpg" alt="" id="faral">
            <div>
            <a href="faral.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Makar Sankranti:TilGul</h4>
            <img src="populardishes/tilgul.jpg" alt="" id="tilgul">
            <div>
            <a href="tilgul.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Pola:Thecha and Bhakari</h4>
            <img src="populardishes/bhakari.jpg" alt="" id="bhakari">
            <div>
            <a href="bhakari.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Kojagiri:Basundi</h4>
            <img src="populardishes/basundi.jpg" alt="" id="basundi">
            <div>
            <a href="basundi.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Holi:PuranPoli</h4>
            <img src="populardishes/puranpoli.jpg" alt="" id="puranpoli">
            <div>
            <a href="puranpoli.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>
	</div>
