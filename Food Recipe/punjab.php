...
<a href="pvideo.php"><button class="custom-button">videos</button></a>
...
<img alt="img" class="ls-s-1"  src="content/dp1.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of Punjab</h1>
...
<img alt="img" class="ls-s-1"  src="content/pp1.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of Punjab</h1>
...
<img alt="img" class="ls-s-1"  src="content/tp1.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Punjab</h1>
...
<section id="home"></section>
        ...
        <div class="dish-container">
            <h4>Baisakhi:Langar</h4>
            <img src="populardishes/langar.jpg" alt="" id="sheer">
            <div>
            <a href="langar.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Gurpurab (Guru Nanak Jayanti):Karah Prashad</h4>
            <img src="populardishes/prasad.jpg" alt="" id="dum">
            <div>
            <a href="prasad.php"><button class="btn1">View Recipe</button></a>
            </div> 
</div>


          <div class="dish-container">
            <h4>Diwali:Pinni And Jilebi</h4>
            <img src="populardishes/pinni.jpg" alt="" id="pulao">
            <div>
            <a href="pinni.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Teej:Ghevar</h4>
            <img src="populardishes/ghevar.jpg" alt="" id="yakhani">
            <div>
            <a href="ghevar.php"><button class="btn1">View Recipe</button></a>
            </div> 

</div>
            <div class="dish-container">
            <h4>Guru Purnima:Malpua and Halwa</h4>
            <img src="populardishes/malpua.jpg" alt="" id="dal">
            <div>
            <a href="malpua.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>
            
          <div class="dish-container">
            <h4>Maghi:Kheer</h4>
            <img src="populardishes/kheer.jpg" alt="" id="trad">
            <div>
            <a href="kheer.php"><button class="btn1">View Recipe</button></a>
            </div> 
