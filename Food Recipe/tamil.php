...
<a href="tvideo.php"><button class="custom-button">videos</button></a>
...
<img alt="img" class="ls-s-1"  src="content/dt1.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Dishes Of TamilNadu</h1>
...
<img alt="img" class="ls-s-1"  src="content/pt.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Popular Of TamilNadu</h1>
...
<img alt="img" class="ls-s-1"  src="content/tt.jpg"  style="position: absolute; top: 100px; left: 0px; slidedirection : top; slideoutdirection : top;  durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1200; delayout : 0; showuntil : 0; ">

<h1  class="ls-s-1" style="position: absolute; top:40px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 1500; durationout : 1500; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 700; delayout : 0; showuntil : 0; font-weight:200;  font-family: verdana; color: #000000;  white-space: nowrap;"> Traditional Of Tamilnadu</h1>
...
<section id="home"></section>
        ...
        <div class="dish-container">
            <h4>Pongal:Sweet Pongal</h4>
            <img src="populardishes/pongal.jpg" alt="" id="sheer">
            <div>
            <a href="pongal.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Chittirai Festival:Madurai Malli Poo Idli</h4>
            <img src="populardishes/idli.jpg" alt="" id="dum">
            <div>
            <a href="idli.php"><button class="btn1">View Recipe</button></a>
            </div> 
</div>


          <div class="dish-container">
            <h4>Tamil New Year (Puthandu):Manga Pacchadi</h4>
            <img src="populardishes/manga.jpg" alt="" id="pulao">
            <div>
            <a href="manga.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>

          <div class="dish-container">
            <h4>Aadi Perukku:Adai</h4>
            <img src="populardishes/adai.jpg" alt="" id="yakhani">
            <div>
            <a href="adai.php"><button class="btn1">View Recipe</button></a>
            </div> 

</div>
            <div class="dish-container">
            <h4>Navaratri:Sundal</h4>
            <img src="populardishes/sundal.jpg" alt="" id="dal">
            <div>
            <a href="sundal.php"><button class="btn1">View Recipe</button></a>
            </div>  
          </div>
            
          <div class="dish-container">
            <h4>Deepavali (Diwali):Mysorepak</h4>
            <img src="populardishes/pak.jpg" alt="" id="trad">
            <div>
            <a href="pak.php"><button class="btn1">View Recipe</button></a>
            </div> 
